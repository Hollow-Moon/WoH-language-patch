[
	...
	"patch_storages.tjs",
	[,,,,, "required initial native plugins"],
	"fstat.dll",
	[,,,,, "exception handler"],
	...
	["krglhjpeg.dll", ,, true, "USE_IMAGELOADER_REPLACEMENTS"],
	...
	["libatrac9.dll", ,, true, "(!KIRIKIROID)&&(SONY_ATRAC&&!USE_WUFFMPEG)"],
	["kratrac9.dll", ,, true, "(!KIRIKIROID)&&(!SONY_ATRAC&&!USE_WUFFMPEG)"],
	...
	["clipboardEx.dll", , [["Clipboard.setAsBitmap"]], true],
	...
	["layerExAdjustGamma.dll", ,, true, "USE_LAYER_IMAGEFUNCTION_REPLACEMENTS"],
	["layerExBoxBlur.dll", ,, true, "USE_LAYER_IMAGEFUNCTION_REPLACEMENTS"],
	["layerExConvertLayerType.dll", ,, true, "USE_LAYER_IMAGEFUNCTION_REPLACEMENTS"],
	["layerExGrayScale.dll", ,, true, "USE_LAYER_IMAGEFUNCTION_REPLACEMENTS"],
	["layerExLRFlip.dll", ,, true, "USE_LAYER_IMAGEFUNCTION_REPLACEMENTS"],
	["layerExUDFlip.dll", ,, true, "USE_LAYER_IMAGEFUNCTION_REPLACEMENTS"],
	["wutcwf.dll", ,, true],
	["layerExSave.dll", , [["Window.startSaveLayerImage"], ["Layer.saveLayerImageTlg5"]], true],
	["extrans.dll", ,, true],
	...
	["krmpv.dll", , [["KrMpv"]], true, "USE_KRMPV"],
	...
	["equations.dll", , [["Equations"]], true, "GAME_WOHN"],
	...
	"patch_taghandlers_override.tjs",
	...
	["StatusMenuLayer.tjs", ,,, "GAME_FATE"],
	["patch_textdrawer_override_fate.tjs", ,,, "TEXT_DRAWER&&GAME_FATE"],
