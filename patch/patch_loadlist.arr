[
	...
	"patch_utils.tjs",
	["patch_plugins.tjs", ,,, "GAME_FATE||GAME_FHAT"],
	["KAGParser.dll", , [["KAGParser"]]],
	["menu.dll", , [["MenuItem"]]],
	["patch_windowex_stubs.tjs", ,,, "kirikiriz"],
	["windowEx.dll", , [["Window.registerExEvent"]]],
	["util.dll", , [["enumFont"]], , "GAME_FATE||GAME_FHAT"],
	["filter.dll", , [["Smudge"]], , "GAME_FATE||GAME_FHAT"],
	["slideopen.dll", , [["initSlideOpen"]], , "GAME_FATE||GAME_FHAT"],
	["drawer.dll", , [["drawLine"]], , "GAME_FATE||GAME_FHAT"],
	["firespark.dll", , [["initFireSpark"]], , "GAME_FATE||GAME_FHAT"],
	["wallpaper.dll", , [["setwallpaper"]], , "GAME_FATE||GAME_FHAT"],
	...
	["load_patches([[mainPatchName, \"k2compat\"]]);", , "!devMode", , "GAME_FATE||GAME_FHAT"],
	["hint.tjs", ,,, "kirikiriz"],
	["k2compat.tjs", ,,, "kirikiriz&&(GAME_FATE||GAME_FHAT)"],
	["Krkr2CompatUtils.scriptBase = \"\";", ,,, "kirikiriz&&(GAME_FATE||GAME_FHAT)"],
	["k2compat2.tjs", ,,, "kirikiriz&&(GAME_FATE||GAME_FHAT)"],
